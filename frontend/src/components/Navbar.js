			...
			<div className="flex flex-row ">
				...
				{width > 550 ? (
					<button
						...
						className="flex items-center bg-white hover:bg-gray-100 text-black font-semibold py-2 px-8 rounded-lg border border-black"
					...
					<button
						onClick={() => dispatch(openModal())}
						className="flex items-center bg-white hover:bg-gray-100 text-black font-semibold py-2 px-8 rounded-lg border border-black"
						style={{ padding: "13px", borderWidth: "1.5px" }}
					>
